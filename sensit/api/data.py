...
class Data():
	...
	def find(self, options = {}):
		...
		response = self.client.get('/topics/' + self.topic_id + '/feeds/' + self.feed_id + '/data/' + self.id + '', body, options)
	...
	def update(self, options = {}):
		...
		response = self.client.put('/topics/' + self.topic_id + '/feeds/' + self.feed_id + '/data/' + self.id + '', body, options)
